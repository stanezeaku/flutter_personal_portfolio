...
List<Project> demoProjects = [
  Project(
      title: "SmartStan",
      description:
          "Simple Face Recognition authentication (Sign up + Sign in). It works with two device vision models working together, the google ML kit vision model and the MobileFaceNet model.",
